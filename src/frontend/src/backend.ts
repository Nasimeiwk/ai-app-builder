...
export class Backend implements backendInterface {
    ...
    async addMessage(arg0: bigint, arg1: string, arg2: string): Promise<Message> {
    ...
    async createSession(arg0: string): Promise<Session> {
        if (this.processError) {
            try {
    ...
    async getMessagesBySession(arg0: bigint): Promise<Array<Message>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMessagesBySession(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
